...
function bcCalcAllSegRow(seg){
  ...
  if(shape==='flat'){
    ...
    document.getElementById('bcBrokRatePrefix').textContent = document.getElementById('bcAllRatePfx_'+seg).textContent;
    ...
    document.getElementById('bcBrokMinSharePrefix').textContent = document.getElementById('bcAllMinPfx_'+seg).textContent;
    document.getElementById('bcBrokMinShareDigit').value = document.getElementById('bcAllMinDigit_'+seg).value;
  } else {
    document.getElementById('bcBrokRate').value = document.getElementById('bcAllRate_'+seg).value;
    document.getElementById('bcBrokRatePrefix').textContent = document.getElementById('bcAllRatePfx_'+seg).textContent;
    document.getElementById('bcBrokRateDigit').value = document.getElementById('bcAllRateDigit_'+seg).value;
